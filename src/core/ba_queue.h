...
/** --------------------------------------------------------------------------------------------------------- Destroy
 * @brief Releases undelivered Slices and storage after every thread binding is released.
 */
...
/** --------------------------------------------------------------------------------------------------------- Push
 * @brief Moves Slices into private blocks and publishes each full block.
 */
